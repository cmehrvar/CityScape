...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CityScape/AWSCore.framework"
  install_framework "Pods-CityScape/AWSS3.framework"
  install_framework "Pods-CityScape/Bolts.framework"
  install_framework "Pods-CityScape/DownPicker.framework"
  install_framework "Pods-CityScape/FBSDKCoreKit.framework"
  install_framework "Pods-CityScape/FBSDKLoginKit.framework"
